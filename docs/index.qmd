...
+ 0:00 - Welcome and Announcements:
  ...
  + To the extent you can read the notes and first two exercises before the workshop, it would help us focus on the final exercise for the duration of the workshop.
...
+ 0:20 - ["Codebase Cleanup" Exercise](./exercises/codebase-cleanup/index.qmd):
...
+ 0:60 - "Python Application" Exercise:
