...
+ 0:05 - Overview of Notes and Concepts:
  + [Python Code Style Guidelines](./notes/style-guidelines.qmd)
  + [Python Code Documentation](./notes/documentation.qmd)
  + [Python Code Simplification and Refactoring](./notes/refactoring.qmd)
...
The agenda above is for a 90 minute workshop, however for a 60 minute workshop, consider doing the Notebook Translation Exercise for homework afterwards.
