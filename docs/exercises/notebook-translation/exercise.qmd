...
[Commit 3](https://github.com/s2t2/my-first-app-inclass-summer-2024/commit/0c8f2124b81eef0563899ef94f91ceb837db4e34) and [Commit 4](https://github.com/s2t2/my-first-app-inclass-summer-2024/commit/0c8f2124b81eef0563899ef94f91ceb837db4e34) (they should have been done at the same time): **Translate the Unemployment Report Notebook**

  + Create a new file in the "app" directory called "unemployment.py", and copy the code from the Unemployment Report Notebook into the "unemployment.py" file.
  ...
  + Run the "unemployment.py" file to see it works.
...
[Commit 5](https://github.com/s2t2/my-first-app-inclass-summer-2024/commit/96d3273c8cb91354c231adf058d1fa5bbc384eee): **Translate the Stocks Report Notebook**
  ...
  + Create a new file in the "app" directory called "stocks.py", and copy the code from the Stocks Report Notebook into the "stocks.py" file.
  ...
  + Run the "stocks.py" file to see it works.
...
TBA: **Send Example Email**
  ...
  + Create a new file in the "app" directory called "emails.py", and copy the code from the Email Sending Notebook pertaining to your chosen email sending service.
